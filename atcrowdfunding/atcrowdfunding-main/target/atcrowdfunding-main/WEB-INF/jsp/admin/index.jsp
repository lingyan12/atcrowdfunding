                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-primary btn-xs"><i
                                                class=" glyphicon glyphicon-pencil" onclick="window.location.href='${PATH}/admin/toUpdate?id=${admin.id}&pageNum=${page.pageNum}'"></i></button>
                                        <button type="button" class="btn btn-danger btn-xs"><i
                                                class=" glyphicon glyphicon-remove" onclick="window.location.href='${PATH}/admin/toDelete?id=${admin.id}&pageNum=${page.pageNum}'"></i></button>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
                                    ...
                                    <ul class="pagination">
                                        ...
                                        <c:forEach items="${page.navigatepageNums}" var="nums">
                                            <c:if test="${nums == page.pageNum}">
                                             <li class="active"><a href="#">${nums} <span class="sr-only">(current)</span></a></li>
